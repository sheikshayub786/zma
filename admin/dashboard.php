...
$totalanimal=$result['totalanimal'];
 ?>  
                                        ...
                                        <img class="tagline-img" src="images/animals.png"/>
...
$count_total_visitors=$result['totaladult'];
 ?>  
                                        ...
                                        <img class="tagline-img" src="images/adult.png"/>
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        ...
                                        <img class="tagline-img" src="images/yesterday.png"/>
                                        <br/>
...
$count_total_visitors=$result['totaladult'];
 ?>  
                                        ...
                                        <img class="tagline-img" src="images/tourist.png"/>
                                       <p style="font-size: 20px;color: red">
...
$count_total_cvisitors=$result['totalchildy'];
 ?>
                                        ...
                                        <img class="tagline-img" src="images/travel.png"/>
                                        <p style="font-size: 20px;color: red">
                                            <?php 
if($count_total_cvisitors==''):
echo "0"; else: 
...
$count_today_visitors=$result['totaladult'];
 ?>  
                                        ...
                                        <img class="tagline-img" src="images/intern.png"/>
                                       <p style="font-size: 20px;color: red">
